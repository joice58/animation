...
(function() {
    ...
    const cssStyles = `
        ...
        #radial-slider-wrapper .slide-image-layer.next {
            z-index: 2;
            -webkit-mask-image: conic-gradient(from 200deg, #000000 0deg, transparent 0deg);
            mask-image: conic-gradient(from 200deg, #000000 0deg, transparent 0deg);
        }
    ...
    class RadialSlider {
        ...
        triggerEntryWipe() {
            ...
            const initMask = `conic-gradient(from 200deg, #000000 0deg, transparent 0deg)`;
            ...
            setTimeout(() => {
                ...
                function entryWipe(now) {
                    ...
                    const maskStr = `conic-gradient(from 200deg, #000000 ${angle}deg, transparent ${angle}deg)`;
        ...
        goToSlide(nextIndex) {
            ...
            if (isForward) {
                ...
                const initMask = `conic-gradient(from 200deg, #000000 360deg, transparent 360deg)`;
                this.imgNext.style.webkitMaskImage = initMask;
                this.imgNext.style.maskImage = initMask;
                this.imgNext.style.opacity = '1';
